...
const renderField = field => <Input {...field.input} type={field.type} />  // type was not mapping in spread operator.
      ...
      <Row>
        ...
        <Col lg={4} xl={4}>
          ...
          <form onSubmit={handleSubmit(this.handleFormSubmit.bind(this))}>
            {this.props.errorMessage ? <span><strong>Error!</strong> {this.props.errorMessage}</span> : ''}
            <Row>
              <Col>
                <Field
                  name="email"
